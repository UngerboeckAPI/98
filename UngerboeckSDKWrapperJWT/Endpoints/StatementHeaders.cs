...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class StatementHeaders : Base<StatementHeadersModel>
  {
    protected internal StatementHeaders(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<StatementHeadersModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public StatementHeadersModel Get(string orgCode, int batchSequence, int sequence, Ungerboeck.Api.Models.Options.Subjects.StatementHeaders options = null)
    {
