...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class PurchaseOrders : Base<PurchaseOrdersModel>
  {
    protected internal PurchaseOrders(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<PurchaseOrdersModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public PurchaseOrdersModel Get(string orgCode, int number, Ungerboeck.Api.Models.Options.Subjects.PurchaseOrders options = null)
    {
      return base.Get(new { orgCode, number }, options);
    }
    ...
    public PurchaseOrdersModel Update(PurchaseOrdersModel model, Ungerboeck.Api.Models.Options.Subjects.PurchaseOrders options = null)
    {
      return base.Update(new { model.Organization, model.Number }, model, options);
    }
    ...
    public PurchaseOrdersModel Add(PurchaseOrdersModel model, Ungerboeck.Api.Models.Options.Subjects.PurchaseOrders options = null)
    {
