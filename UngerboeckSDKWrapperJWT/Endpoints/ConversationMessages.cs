...
{
  public class ConversationMessages : Base<ConversationMessagesModel>
  {

    protected internal ConversationMessages(ApiClient api) : base(api) { }
    ...
    public Ungerboeck.Api.Models.Search.SearchResponse<ConversationMessagesModel> Search(string searchOData, Search options = null)
    {
    ...
    public ConversationMessagesModel Get(int id, Ungerboeck.Api.Models.Options.Subjects.ConversationMessages options = null)
    {
