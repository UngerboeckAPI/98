...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class MembershipAccountItems : Base<MembershipAccountItemsModel>
  {
    protected internal MembershipAccountItems(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<MembershipAccountItemsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public MembershipAccountItemsModel Get(string orgCode, int id, Ungerboeck.Api.Models.Options.Subjects.MembershipAccountItems options = null)
    {
      return base.Get(new { orgCode, id }, options);
    }
  }
}
