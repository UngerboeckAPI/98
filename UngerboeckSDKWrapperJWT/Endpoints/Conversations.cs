...
{
  public class Conversations : Base<ConversationsModel>
  {

    protected internal Conversations(ApiClient api) : base(api) { }
    ...
    public Ungerboeck.Api.Models.Search.SearchResponse<ConversationsModel> Search(string searchOData, Search options = null)
    {
    ...
    public ConversationsModel Get(int id, Ungerboeck.Api.Models.Options.Subjects.Conversations options = null)
    {
